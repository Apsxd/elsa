...
if ENV:
    ...
    spamwatch_api = os.environ.get("sw_api", "mdw_NNM2UvqAPFnxR2FfXaFa0FZMv3C1iraEL8YmclZ9GMn7R4X5C8D4D_d3ZEdY")
...
telethn = TelegramClient("kaali", API_ID, API_HASH)
dispatcher = updater.dispatcher
kp = Client("KaaliPyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
