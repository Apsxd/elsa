...
__help__ = """
Note: the userbots running in strings may join your group and they would send spam messages to avoid this setup captcha in group

**CAPTCHA**

- /welcomemute soft [users cant send media on group before a limited time
- /welcomemute strong [users will be stay muted if they didnt answerd captcha
- /welcomemute off [turn off welcomemute
"""
